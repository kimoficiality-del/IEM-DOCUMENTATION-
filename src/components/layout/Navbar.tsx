...
import { Menu, X, ArrowRight, HardHat, ChevronDown } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden lg:flex items-center gap-6">
            <div className="flex items-center gap-1">
              {navLinks.map((link) => (
                <Link
                  key={link.name}
                  to={link.href}
                  className={`px-4 py-2 text-sm font-semibold transition-all rounded-full hover:bg-zinc-100 ${
            ...
            <Button className="rounded-full bg-blue-700 hover:bg-blue-800 text-white px-6 font-bold shadow-md shadow-blue-700/10 gap-2 group">
              Consult an Expert
          ...
          >
            <div className="flex flex-col gap-2">
              ...
              <div className="mt-4 pt-6 border-t border-zinc-100">
                <Button className="w-full bg-blue-700 text-white rounded-2xl py-8 text-lg font-bold shadow-xl shadow-blue-700/20">
                  Book a Consultation
                </Button>
              </div>
            </div>
